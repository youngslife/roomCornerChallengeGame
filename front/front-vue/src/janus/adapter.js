        ...
        function(require, module, exports) {
          ...
          var edgeShim = {
            shimPeerConnection: function() {
              ...
              window.RTCPeerConnection.prototype._emitBufferedCandidates = function() {
                ...
                this._localIceCandidatesBuffer.forEach(function(event) {
                  ...
                  if (end) {
                    ...
                    event.candidate.candidate.indexOf("typ endOfCandidates") ===
                    -1
                  ) {
              ...
              window.RTCPeerConnection.prototype._getCommonCapabilities = function(
                localCapabilities,
                remoteCapabilities
              ) {
              ...
              window.RTCPeerConnection.prototype._createIceAndDtlsTransports = function(
                mid,
                sdpMLineIndex
              ) {
                var self = this;
           ...
           */
              ...
              window.RTCPeerConnection.prototype._updateSignalingState = function(
                newState
              ) {
